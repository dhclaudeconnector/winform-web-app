-- =====================================================
-- SCRIPT NHANH: GÁN ROLE ADMIN CHO USER admin
...
-- Bước 2: Gán role ADMIN cho user admin
...
SELECT
    ...
    permission_code,
    granted
FROM webauth.get_user_permissions('admin')
WHERE granted = true
...
-- ---------|-----------|----------------|------------------
-- admin    | ADMIN     | Quản trị viên  | 36
--
-- SAU ĐÓ:
-- 1. LOGOUT khỏi ứng dụng
-- 2. LOGIN lại với user "admin"
